...
export const services: ServiceItem[] = [
  {
    ...
    description: 'Mobile and business applications designed around usability, speed, and long-term scale.',
  ...
  },
  {
    ...
    description: 'Brand visuals, marketing creatives, video editing, and polished design assets created to strengthen recognition and presentation.',
    points: ['Social media creatives', 'Brand support visuals', 'Marketing and promotional design', 'Video editing for reels, ads, and branded content'],
    outcomes: 'Ideal for brands that need stronger visual identity, cleaner campaign creatives, polished video content, and more professional communication.',
    overview:
      'Our Graphic Designing service helps businesses present themselves more professionally across digital and marketing touchpoints. We create visuals and edited video assets that support campaigns, branding, promotion, and content presentation.',
    deliverables: ['Social media post design', 'Ad and campaign creatives', 'Brand support graphics', 'Presentation and promotional visuals', 'Video editing for short-form content and ads', 'Creative design packages for marketing use'],
    process: ['Creative direction and reference gathering', 'Visual concept development', 'Design and video editing refinement', 'Final asset preparation and delivery'],
  ...
  {
    slug: 'saas-design-and-development',
    icon: Workflow,
  ...
  },
  {
    ...
    description: 'Automations that connect tools, remove manual work, and keep leads or operations moving without friction.',
