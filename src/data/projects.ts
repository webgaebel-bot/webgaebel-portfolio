...
const projectSeeds = [
  ...
  },
  {
    ...
    description: 'School management platform concept for administration, reporting, and student operations.',
    color: 'from-blue-600 to-teal-700',
    gradientA: '#2563eb',
    gradientB: '#0f766e',
    challenge: 'The system needed to organize school operations without making the interface feel heavy.',
    solution: 'We planned the dashboard around core admin tasks, student records, and simple reporting paths.',
    impact: ['Clearer admin flow', 'Better record organization', 'Scalable platform structure'],
    deliverables: ['Dashboard UI', 'Student records', 'Reports layout', 'Admin screens'],
  },
